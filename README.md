...
--> Compare RV points of up to four different data sets

Future fixes:
--> Needs to work better for non-MAROON-X data
-->--> Currently only functioning for 2-instrument data products (i.e. camera 1 and camera 2), with naming conventions like 'Barnard_1.csv', 'Barnard_2.csv'
