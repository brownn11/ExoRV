...
if args.points_only:
    p.points_only(tn =  args.target_name, TOI = args.TOI, path = args.local_path, name = args.file_name, offsets = args.offsets, singleplot = args.singleplot)
elif args.curve_only:
    p.curve_only(TOI = args.TOI, others = args.others)
else:
    p.RV_plotter(tn =  args.target_name, TOI = args.TOI, others = args.others, path = args.local_path, name = args.file_name, offsets = args.offsets, singleplot = args.singleplot)